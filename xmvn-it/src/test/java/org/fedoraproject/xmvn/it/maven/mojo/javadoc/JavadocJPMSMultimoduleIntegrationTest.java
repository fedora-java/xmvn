...
public class JavadocJPMSMultimoduleIntegrationTest extends AbstractMojoIntegrationTest {
    ...
    public void testJavadocJPMSMultimodule() throws Exception {
        ...
        assertTrue(Files.isRegularFile(Path.of("target/xmvn-apidocs/B.html")));
        assertTrue(Files.isRegularFile(Path.of("target/xmvn-apidocs/a/module-summary.html")));
        assertTrue(Files.isRegularFile(Path.of("target/xmvn-apidocs/b/module-summary.html")));
